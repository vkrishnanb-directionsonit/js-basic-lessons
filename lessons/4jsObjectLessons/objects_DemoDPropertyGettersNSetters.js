...
// JavaScript invokes these functions as methods of the object on 
...
var serialnum = {
  // This data property holds the next serial number.
    ...
    // But doesn't work like private field
  $n: 0,
...
class RegisterNumber {
  ...
  callPrint() {return this.#printToScreen();}
}
const rn = new RegisterNumber();
console.log(`Next Number ${rn.getNumber()}`);
console.log(`Print Number ${rn.callPrint()}`);
